...
function uespEsoSkills_beforePageDisplay(&$out) {
	...
	$out->addHeadItem("uesp-jqueryui1-js", "<script src='http://esolog-static.uesp.net/resources/jquery-ui.min.js?version=28Mar2017'></script>");
	$out->addHeadItem("uesp-jqueryui2-js", "<script src='http://esolog-static.uesp.net/resources/jquery.ui.touch-punch.min.js?version=28Mar2017'></script>");
	...
	$out->addHeadItem("uesp-esoskillsbrowser-css", "<link rel='stylesheet' href='http://esolog-static.uesp.net/resources/esoskills_embed.css?31Mar2017' />");
	$out->addHeadItem("uesp-esoskillsbrowser-js", "<script src='http://esolog-static.uesp.net/resources/esoskills.js?31Mar2017'></script>");
